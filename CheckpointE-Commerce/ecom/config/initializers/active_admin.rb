ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "aa"

  # == Localize
  #
  # Set the default locale for Active Admin.
  # This will enable localization for the admin interface.
  #
  ...
  # Sort menu items alphabetically (except for items with explicit priority)
  config.namespace :admin do |admin|
    admin.build_menu :default do |menu|
      # The menu is already sorted by ActiveAdmin by default priority
      # Items without explicit priority are sorted alphabetically by their label
    end
  end
...
# Include Chartkick helpers in ActiveAdmin
# Use to_prepare to ensure ActiveAdmin is loaded first
