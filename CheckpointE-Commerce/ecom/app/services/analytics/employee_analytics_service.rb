...
module Analytics
  class EmployeeAnalyticsService
    ...
    def products_data
      ...
      items_with_stats = @shop.items.map do |item|
        {
          item: item,
    ...
    def orders_data
...

      {
        ...
        orders_by_day: shop_orders.group_by_day(:created_at, time_zone: "UTC").count,
    ...
    def orders_count
      @shop.orders.where(created_at: @time_range).count
    end
