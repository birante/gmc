module Employees
  class FinancesController < Employees::BaseController
  def index
    # @vendor positionné par Employees::BaseController#set_employee_for_view
    return redirect_to employees_dashboard_path, alert: "Vendeur non trouvé" unless @vendor
  ...
  def show_payout
    ...
    unless @payout
      redirect_to payouts_employees_finances_path(shop_slug: @current_shop&.slug), alert: "Reversement non trouvé"
    end
  end
